# Panel de administración (`@elineas/auth-frontend`)
...
Necesita la API levantada (`bun run dev:backend`) y su propio entorno:
...
respuesta los deriva TypeScript de `@elineas/auth-backend/rpc`, así que un cambio en
