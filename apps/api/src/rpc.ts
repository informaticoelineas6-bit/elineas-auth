// Entry público del contrato RPC del paquete `@elineas/auth-api` (ver el campo
// "exports" en package.json: `@elineas/auth-api/rpc`).
//
...
// `apps/admin/src/modules/common/lib/rpc.ts`).
