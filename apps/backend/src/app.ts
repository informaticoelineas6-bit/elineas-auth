...
import { handleError } from "@backend/lib/http.ts";
import { registerRequestLogging } from "@backend/middleware/request-log.ts";
import { registerSecurityMiddleware } from "@backend/middleware/security.ts";
import { registerAuthRateLimits } from "@backend/middleware/auth-rate-limits.ts";
import { registerHealthChecks } from "@backend/routes/health.routes.ts";
import { registerRoutes } from "@backend/routes/index.ts";
import { registerOpenApiDocs } from "@backend/openapi/docs.ts";
...
export { openApiInfo } from "@backend/openapi/docs.ts";
